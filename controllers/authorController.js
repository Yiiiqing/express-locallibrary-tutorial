...
//     .isISO8601,
//   body("date_of_death", "Invalid date of birth").optional({ checkFalsy: true })
//     .isISO8601,
...
exports.author_delete_post = (req, res) => {
  async.parallel(
    {
      author: function(callback) {
        //我们验证是否已提供id（这是通过表单主体参数发送的，而不是使用URL中的版本）
...
exports.author_update_post = [
  ...
  body("first_name")
    .isLength({ min: 1 })
    .trim()
    .withMessage("First name muust be specified.")
    .isAlphanumeric()
    .withMessage("First name has non-alphanumeric characters."),
